...
export const GlobeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9-3.75h.008v.008H12v-.008zM12 15h.008v.008H12v-.008zm0 2.25h.008v.008H12v-.008zM3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5M5.625 1.5H5.625a2.25 2.25 0 012.25 2.25v1.875a2.25 2.25 0 01-2.25 2.25H5.625a2.25 2.25 0 01-2.25-2.25V3.75a2.25 2.25 0 012.25-2.25zM18.375 1.5h.008a2.25 2.25 0 012.25 2.25v1.875a2.25 2.25 0 01-2.25 2.25h-.008a2.25 2.25 0 01-2.25-2.25V3.75a2.25 2.25 0 012.25-2.25z" />
    </svg>
);
